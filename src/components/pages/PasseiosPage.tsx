...
export default function PasseiosPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Os passeios incluem transporte, guia experiente e paradas nos principais pontos turísticos. Durante o trajeto, você terá tempo para fotos, banho nas lagoas e parada para almoço (não incluso no valor do passeio). É a forma mais prática e segura de aproveitar ao máximo os passeios em Jericoacoara.",
    },
  ];
