      ...
      <section id="historia" className="bg-orange-600 min-h-screen flex items-center justify-center py-20 px-6 text-white">
        <div className="max-w-5xl w-full">
          <div className="flex flex-col items-center mb-12">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-center">História de Jericoacoara</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 leading-relaxed">
            <div className="space-y-6">
              <p className="text-xl md:text-2xl font-light">
                ...
                ericoacoara, carinhosamente apelidada de Jeri, é um destino onde o tempo parece ditar o próprio ritmo...
              </p>
              <p className="text-lg opacity-90 border-l-2 border-white/20 pl-6 italic">
                Localizada no Ceará, a cerca de 300 km de Fortaleza, transformou-se em um refúgio de fama internacional.
              </p>
            </div>
            <div className="space-y-6 text-lg">
              <p>A história mudou em 1984, quando o Washington Post a elegeu como uma das dez praias mais bonitas do mundo.</p>
              <p>Hoje, protegida como Parque Nacional, a jornada passa pela icônica Pedra Furada e a Duna do Pôr do Sol.</p>
            </div>
          </div>
        </div>
      </section>
